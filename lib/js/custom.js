...
/*
// Remove right panel info
var r_panel = document.body.querySelector("aside#sidebar");
console.log(r_panel);
r_panel.querySelector("p").remove();

// Move h6 into right panel
var r_panel_items = document.body.querySelectorAll("h6");
